  ...
  const products: ProductType[] = [
    {
      id: 1,
      price: 2200,
      image: "/images/cop.webp",
      alt: "Dell XPS 15 9520, 15.6” 4K OLED, Intel Core i9, 32GB RAM, 1TB SSD",
      description: "Dell XPS 15 9520, 15.6” 4K OLED, Intel Core i9, 32GB RAM, 1TB SSD",
    },
    {
      id: 2,
      price: 1200,
      alt: "Gaming PC Intel Core i7 12th Gen, 16GB RAM, 1TB SSD, NVIDIA RTX 3060 12GB",
      image: "/images/comp.webp",
      description: "Gaming PC Intel Core i7 12th Gen, 16GB RAM, 1TB SSD, NVIDIA RTX 3060 12GB",
    },
    {
      id: 4,
      price: 399,
      image: "/images/Screen mobile.webp",
      alt: "Sony WH-1000XM5 Wireless Noise Cancelling Headphones, 30 Hours Battery",
