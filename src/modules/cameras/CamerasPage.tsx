  ...
  const products: ProductType[] = [
    {
      id: 1,
      price: 1200,
      alt: "Sony A7 III Camera",
      image: "/images/Iphone 14 pro (1).webp",
      description: "Sony A7 III Mirrorless Camera, 24.2MP Full-Frame, 4K HDR Video",
    },
    {
      id: 2,
      price: 2200,
      ...
      description: "Fujifilm X-T4 Mirrorless Camera, 26.1MP APS-C Sensor, 4K/60fps Video",
    },
    {
      id: 3,
      price: 399,
